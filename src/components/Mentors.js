                        ...
                        <form
                            ...
                            <div id="mc_embed_signup_scroll">
                                <div className="mc-field-group">
                                    <input type="text" value="" name="FNAME" className="required mentor-form-input"
                                        id="mce-FNAME" placeholder="First Name" required />
                                </div>
                                <div className="mc-field-group">
                                    <input type="text" value="" name="LNAME" className="required mentor-form-input"
                                        id="mce-LNAME" placeholder="Last Name" required />
                                </div>
                                <div className="mc-field-group">
                                    <input type="email" value="" name="EMAIL" className="required mentor-form-input"
                                        id="mce-EMAIL" placeholder="Email Address" required />
                                </div>
                                <div className="mc-field-group">
                                    <input type="text" value="" name="EXPERTISE" className="required mentor-form-input"
                                ...
                                <div style={{ display: 'none' }} className="mc-field-group input-group">
                                    ...
                                    <ul>
                                        <li>
                                            <input type="checkbox" value="1" name="group[24713][1]"
